  ...
  module TagDefinitions # :nodoc:
    class TagFactory # :nodoc:
      ...
      protected
        ...
        # Normalizes options passed to tag definition. Override in descendants to perform
        ...
        # Validates parameters passed to tag definition. Override in descendants to add custom
        # validations.
